            ...
            <div class="py-container">
                <div class="shortcut">
                    ...
                    <ul class="fr">
                        ...
                        <li class="f-item"><a href="seckillOrder.html" target="_blank">我的张六儿购</a></li>
                        <li class="f-item space"></li>
                        <li class="f-item">张六儿购会员</li>
                        <li class="f-item space"></li>
                        <li class="f-item">企业采购</li>
                        <li class="f-item space"></li>
                        <li class="f-item">关注张六儿购</li>
                        <li class="f-item space"></li>
            ...
            <div class="py-container">
                <div class="yui3-g Logo">
                    <div class="yui3-u Left logoArea">
                        <a class="logo-bd" title="张六儿购" href="/newPageHomeAction/index" target="_blank"></a>
                    </div>
        ...
        <div class="product-info">
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom"><img jqimg="${product.productPicture}" src="${product.productPicture}"
            ...
            <div class="fr itemInfo-wrap">
                ...
                <div class="news">
                    ...
                    <span style="display: none" id="startTime"><fmt:formatDate value="${product.startTime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
                    <span style="display: none" id="endTime"><fmt:formatDate value="${product.endTime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
                    <span><img src="/img/_/clock.png"/>张六儿秒杀</span>
                    <span class="overtime"><span id="remainTime"></span></span>
                </div>
                <div class="summary">
                    <div class="summary-wrap">
                        ...
                        <div class="fl price">
                            <i>¥</i>
                            <em>${product.miaoshaPrice}</em>
                            <span>原价：${product.originalPrice}</span>
                        </div>
                        <div class="fr remark">
                            剩余库存：${product.stockCount}
                        </div>
                    </div>
                    <div class="summary-wrap">
                        <div class="fl title">
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <form action="/orderAction/toPayOrder" id="ac">
                                        <input type="hidden" name="id" value="${product.id}">
                                        <input type="hidden" name="count" value="1">
                                        <a id="buyBtn" href="javascript:void(0)" onclick="submit(this)"
    ...
    <div class="py-container">
        <div class="footlink">
            ...
            <div class="Mod-copyright">
                ...
                <p>地址：北京市海淀区中关村张六儿购 邮编：100000 电话：1542322322 传真：010-45434343 邮箱：2920681274@qq.com</p>
