        ...
        <ul class="seckill" id="seckill">
            <c:forEach items="${list}" var="item">
                <li class="seckill-item">
                    ...
                    <div class='price'><b class='sec-price'>￥${item.miaoshaPrice}</b><b
                    ...
                    <div class='num'>
                        ...
                        <div class='progress'>
                            <div class='sui-progress progress-danger'><span
                                    style='width: {{((pojo.count-pojo.stockCount)/pojo.count*100).toFixed(0) }}%;'
                                    class='bar'></span></div>
                        </div>
                        <div>剩余<b class='owned'>${item.stockCount}</b>件</div>
                    </div>
                    <a class='sui-btn btn-block btn-buy'
                       href='/newPageHomeAction/viewProductDetail?id=${item.id}'>立即抢购</a>
                </li>
            </c:forEach>
        </ul>
    </div>
